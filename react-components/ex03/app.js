...
console.warn('Folosind Object.values(), afiseaza o lista inversata cu ' +
...
let message = Object.values(person.friends).reduce((message, {name}, index, friends) => {
...
console.warn('Prin aceeasi metoda, afiseaza propozitia: ' +
