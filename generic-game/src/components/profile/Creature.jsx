    ...
    <div className="creature" style={{
      ...
      <div className="creature__eyes">
        <div className="eye eye--blinking creature__eye creature__eye--left">
          <div className="eye__iris" style={{
            backgroundColor: eyeColor,
          }}></div>
          <div className="eye__lid" style={{
      ...
      <div className="creature__nose-line">
        <div className="nose creature__nose" style={{
          backgroundColor: secondaryColor,
          borderColor: mainColor,
        }}>
          <div className="nose__nostril nose__nostril--left" style={{
            backgroundColor: mainColor
          }}></div>
          <div className="nose__nostril nose__nostril--right" style={{
            backgroundColor: mainColor
          }}></div>
        </div>
      </div>
